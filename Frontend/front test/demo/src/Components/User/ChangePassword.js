...
function ChangePassword(props) {
  ...
  const handleSubmit = (e) => {
    ...
    BankServices.userChangePassword(props.user.id, { email:props.user.email,password: oldPassword, newPassword: newPassword }).then((obj) => displayMassage(obj));
  }
  function displayMassage(obj) {
    const message = document.getElementById("messagecp");
