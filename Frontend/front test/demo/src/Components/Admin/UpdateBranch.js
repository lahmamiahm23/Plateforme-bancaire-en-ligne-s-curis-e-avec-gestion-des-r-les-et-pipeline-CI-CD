                    ...
                    <Form>
                        ...
                        <div className="d-flex flex-row m-3">
                            <Form.Group className="mb-3 px-1" >
                                ...
                                <Form.Control type="text" value={branch.phoneNumber} name='phoneNumber' placeholder="phoneNumber" onChange={(event) => setBranch({ ...branch, phoneNumber: event.target.value })} maxLength={12} required pattern='^(?:(?:\+|0{0,2})212(\s*[\-]\s*)?|0)?[5-7]\d{8}$' />
                            </Form.Group>
