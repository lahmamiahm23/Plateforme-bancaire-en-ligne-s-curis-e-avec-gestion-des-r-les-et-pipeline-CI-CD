...
function ChangePassword(props) {
    ...
    const handleOldPasswordChange = (e) => {
      ...
      const handleSubmit = (e) => {
        ...
        BankServices.changePasswordEmployee(props.user.id,{email:props.user.email,password:oldPassword,newPassword:newPassword}).then((obj)=>displayMassage(obj));
      }
        ...
        <h2>Login</h2>
            ...
            <div className="card-body">
              <form onSubmit={handleSubmit}>
                ...
                <button type="button" onClick={handleSubmit} className="btn btn-primary btn-block mt-3">Change Password</button>
              </form>
            </div>
          </div>
        </div>
